...
for MONTH in ${MONTHS[*]}
do
    echo -e "\n\033[40;1;37m Rodando para meses impares, orgão: ${COURT}, ano: ${YEAR} e mês: ${MONTH} \033[0m"

    sudo ./executor --in=${COURT,,}.json \
    --volume-dir=/output1 --volume-name=dadosjusbr1 \
    --def-run-env=OUTPUT_FOLDER:/output1 \
